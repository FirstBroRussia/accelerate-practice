...
import { UsersMicroserviceEnvInterface } from "../interface/users-microservice-env.interface";
import { plainToInstance } from "class-transformer";

class UsersEnvValidateConfig implements UsersMicroserviceEnvInterface {
  @IsString()
  HOST: string;
