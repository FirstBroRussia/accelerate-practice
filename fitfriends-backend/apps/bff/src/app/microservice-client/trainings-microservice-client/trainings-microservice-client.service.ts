...
import { CoachTrainingRdo, CreateCoachTrainingDto, CustomErrorResponseType, FindCoachTrainingsQuery, UpdateCoachTrainingDto, UpdateRatingCoachTrainingDto } from '@fitfriends-backend/shared-types';
...
export class TrainingsMicroserviceClientService {
  ...
  public async getTrainingList(creatorUserId: string, dto: FindCoachTrainingsQuery): Promise<CoachTrainingRdo[]> {
