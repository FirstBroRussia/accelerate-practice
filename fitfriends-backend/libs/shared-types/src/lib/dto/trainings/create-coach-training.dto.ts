...
import { IsBoolean, IsEnum, IsInt, IsNotEmpty, IsString, Max, MaxLength, Min, MinLength } from "class-validator";
...
import { CoachTrainingInterface } from "@fitfriends-backend/shared-types";


export class CreateCoachTrainingDto implements CoachTrainingInterface {
  @Expose()
  @Type(() => String)
  @IsNotEmpty()
  @IsString()
